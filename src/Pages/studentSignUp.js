          ...
          <div className='lgnd1' style={{ height: "97vh", width: "70%" }}>
            ...
            <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "flex-start", height: "60px", justifyContent: "space-evenly" }}>
              <select onChange={(e) => setSkills([...skills,e.target.value])} style={{ width: "100%", height: 40,border:validation===true&skills.length<1?"1px solid red":"1px solid grey" }}>
                ...
                <option>Intense analytical skills</option>
                <option>Ability to see past through the "frontend" of things</option>
                <option>Love or passion or even curiosity about programming</option>
                <option>Love or passion or even curiosity about data science</option>
                <option>Desire to become a Software Developer</option>
                <option>Love or passion or even curiosity about Artificial Intelligence</option>
                <option>Love or passion or even curiosity about Business Intelligence</option>
                {courseData.map((i)=>
